...
class Model:
    ...
    model: str = field(metadata={"namespace": namespace_map["ili"]})
...
class Models:
    elements: List[Model] = field(
        ...
        metadata={
            "type": "Elements",
            "choices": ({"name": "model", "type": Model, "namespace": namespace_map["ili"]},),
        },
    )
...
class HeaderSection:
    ...
    models: Models = field(metadata={"namespace": namespace_map["ili"]})
